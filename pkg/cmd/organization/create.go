...
import (
	...
	"github.com/maxwelbm/mdz/internal/domain/repository"
	"github.com/maxwelbm/mdz/internal/rest"
	"github.com/maxwelbm/mdz/pkg/cmd/utils"
	"github.com/maxwelbm/mdz/pkg/factory"
	"github.com/maxwelbm/mdz/pkg/output"
	"github.com/maxwelbm/mdz/pkg/tui"
...
func (f *factoryOrganizationCreate) runE(cmd *cobra.Command, _ []string) error {
	...
	output.FormatAndPrint(f.factory, resp.ID, "Organization", output.Created)
